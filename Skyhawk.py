...
async def start_skyhawk():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@donxd"))
            await idk(functions.channels.JoinChannelRequest(channel="@skyhawk_support"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@donxd"))
            await ydk(functions.channels.JoinChannelRequest(channel="@skyhawk_support"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@donxd"))
            await wdk(functions.channels.JoinChannelRequest(channel="@skyhawk_support"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@donxd"))
            await hdk(functions.channels.JoinChannelRequest(channel="@skyhawk_support"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@donxd"))
            await sdk(functions.channels.JoinChannelRequest(channel="@skyhawk_support"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@donxd"))
            await adk(functions.channels.JoinChannelRequest(channel="@skyhawk_support"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@donxd"))
            await bdk(functions.channels.JoinChannelRequest(channel="@skyhawk_support"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@donxd"))
            await cdk(functions.channels.JoinChannelRequest(channel="@skyhawk_support"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@donxd"))
            await ddk(functions.channels.JoinChannelRequest(channel="@skyhawk_support"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@donxd"))
            await edk(functions.channels.JoinChannelRequest(channel="@skyhawk_support"))
...
loop.run_until_complete(start_skyhawk())       
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        skyhawk = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)     
        if len(e.text) > 5:
            bio = str(skyhawk[0])
            text = "Changing Bio"
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(skyhawk) == 2:
            message = str(skyhawk[1])
            counter = int(skyhawk[0])
            if counter > 100:
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
        skyhawk = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        skyhawksexy = skyhawk[1:]
        if len(skyhawksexy) == 2:
            message = str(skyhawksexy[1])
            counter = int(skyhawksexy[0])
            sleeptime = float(skyhawk[0])
            for _ in range(counter):
...
print("")
print("skyhawk Multi Spam Bot Started Sucessfully.")
